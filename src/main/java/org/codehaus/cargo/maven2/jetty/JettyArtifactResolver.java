 ...
 *
 * @version $Id: JettyArtifactResolver.java 1702 2008-09-02 12:37:46Z adriana $
 */
public class JettyArtifactResolver
{
        ...
        ArtifactRepository localRepository, List repositories, ArtifactFactory artifactFactory)
    {
        ...
        jetty6xDependencies.add(new Dependency("javax.servlet", "servlet-api", "2.5"));
        jetty6xDependencies.add(new Dependency("org.mortbay.jetty", "jetty", "6.1.15"));
        jetty6xDependencies.add(new Dependency("org.mortbay.jetty", "jetty-util", "6.1.15"));
        jetty6xDependencies.add(new Dependency("org.mortbay.jetty", "jetty-naming", "6.1.15"));
        jetty6xDependencies.add(new Dependency("org.mortbay.jetty", "jetty-plus", "6.1.15"));
        jetty6xDependencies.add(new Dependency("org.mortbay.jetty", "jsp-2.1", "6.1.14"));
        jetty6xDependencies.add(new Dependency("org.mortbay.jetty", "jsp-api-2.1", "6.1.14"));
        jetty6xDependencies.add(new Dependency("org.eclipse.jdt", "core", "3.1.1"));
